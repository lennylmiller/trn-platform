...
import type { SlideType } from '@trn-platform/shared';

export interface AddSlideDialogProps {
  open: boolean;
  onClose: () => void;
  onAdd: (slideType: SlideType, title: string) => void;
}

const SLIDE_TYPES: { value: SlideType; label: string; description: string }[] = [
...
export function AddSlideDialog({ open, onClose, onAdd }: AddSlideDialogProps) {
  const [selected, setSelected] = useState<SlideType>('narrative');
